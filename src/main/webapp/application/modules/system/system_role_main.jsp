...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
    	<div class="sear" id="query_form"> 
        	<label>角色ID：<input type="text" size="8" id="query_user_ID" /></label>
            <label>角色名 :<input type="text" size="8" id="query_num"/></label>
            <label>描述 :<input type="text" size="6" id="query_name"/></label>
            <label>父ID :<input type="text" size="6" id="query_name"/></label>
