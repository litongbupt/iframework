...
<div class="section">
	...
	<div class="portlert-form-list">
		<div class="portlert-form-row">
			<label class="portlert-form-label"><em>*</em>登陆名称：</label>
		...
		<div class="portlert-form-row">	
			...
			<div class="portlert-form-collection">
				<select id="add_organ" name="organ" class="portlert-form-select">	
		...
		<div class="portlert-form-row">
			...
			<div class="portlert-form-collection">
				<input id="add_station" name="station" type="text" class="portlert-form-input-field" />
				<span class="portlert-form-msg-alert">&nbsp;</span>
			</div>
		</div>	
		<div class="portlert-form-row">
			...
			<div class="portlert-form-collection">
				<input id="add_birthday" name="birthday" type="text" class="portlert-form-input-field time"  style="text-align: left"/>
				<span class="portlert-form-msg-alert">&nbsp;</span>
			</div>
		</div>	
		<div class="portlert-form-row">
			...
			<div class="portlert-form-collection">
				<input id="add_hireday" name="hireday" type="text" class="portlert-form-input-field time"  style="text-align: left"/>
				<span class="portlert-form-msg-alert">&nbsp;</span>
			</div>
		</div>	
	</div>
