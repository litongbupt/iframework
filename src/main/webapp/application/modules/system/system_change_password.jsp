			...
			<div class="edit" style="margin-left:10px;">
				<div class="welcome">
					<div class="portlert-form-list"
						style="position:absolute;width:400px;height:200px;left:50%;top:50%;margin:-100px 0 0 -200px;">
						<form id="changePasswordForm" method="post"
							action="/DRTS/system/user_changePassword.action">
							<div class="portlert-form-row">
								<label class="portlert-form-label">用 户 名:</label>
								<div class="portlert-form-collection">
									<input type="text" id="userId"
										class="portlert-form-input-field user" name="userId"
										value="${sessionScope.user.userId}" readonly="readonly" /> <span
